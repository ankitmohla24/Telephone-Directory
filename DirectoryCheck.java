...
public class DirectoryCheck {
    ...
    public static void main(String a[]){
        ...
        try {
            ...
            obj.command = a[0].trim();
            
            int counter = 1;
            while (counter < a.length){
                obj.input = obj.input + a[counter] + " ";
                counter++;
            }
            ...
            if(!obj.input.equals("")) {
                ...
                if (obj.telNumStrtIndex != 0) {
                    ...
                    obj.name = obj.input.substring(0, obj.telNumStrtIndex).trim();
                    obj.parseString = obj.readFromFile();
                    String temp = obj.parseString.get(obj.name);
                    if((temp == null || temp.equals(""))){

                    }else{
                        obj.error("Name already exists!");
                    }
